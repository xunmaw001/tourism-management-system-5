...
public class JingdianjieshaoController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,JingdianjieshaoEntity jingdianjieshao, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,JingdianjieshaoEntity jingdianjieshao, HttpServletRequest request){
        EntityWrapper<JingdianjieshaoEntity> ew = new EntityWrapper<JingdianjieshaoEntity>();
		PageUtils page = jingdianjieshaoService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, jingdianjieshao), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R thumbsup(@PathVariable("id") String id,String type){
        JingdianjieshaoEntity jingdianjieshao = jingdianjieshaoService.selectById(id);
        if(type.equals("1")) {
        	jingdianjieshao.setThumbsupnum(jingdianjieshao.getThumbsupnum()+1);
        } else {
        	jingdianjieshao.setCrazilynum(jingdianjieshao.getCrazilynum()+1);
        }
        jingdianjieshaoService.updateById(jingdianjieshao);
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<JingdianjieshaoEntity> wrapper = new EntityWrapper<JingdianjieshaoEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = jingdianjieshaoService.selectCount(wrapper);
