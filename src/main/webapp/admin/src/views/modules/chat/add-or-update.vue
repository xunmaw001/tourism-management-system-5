      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="管理员id" prop="adminid">
          <el-input v-model="ruleForm.adminid" 
              placeholder="管理员id" clearable  :readonly="ro.adminid"></el-input>
        </el-form-item>
        <div v-else>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="是否回复" prop="isreply">
          <el-input v-model="ruleForm.isreply" 
              placeholder="是否回复" clearable  :readonly="ro.isreply"></el-input>
        </el-form-item>
        <div v-else>
