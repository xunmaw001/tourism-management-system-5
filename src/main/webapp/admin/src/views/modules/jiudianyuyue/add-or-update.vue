  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="酒店名称" prop="jiudianmingcheng">
              <el-input v-model="ruleForm.jiudianmingcheng" 
                placeholder="酒店名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="酒店星级" prop="jiudianxingji">
          <el-select v-model="ruleForm.jiudianxingji" placeholder="请选择酒店星级">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="酒店星级" prop="jiudianxingji">
	      <el-input v-model="ruleForm.jiudianxingji"
                placeholder="酒店星级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="酒店位置" prop="jiudianweizhi">
              <el-input v-model="ruleForm.jiudianweizhi" 
                placeholder="酒店位置" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="周边景点" prop="zhoubianjingdian">
          <el-select v-model="ruleForm.zhoubianjingdian" placeholder="请选择周边景点">
            <el-option
                v-for="(item,index) in zhoubianjingdianOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="周边景点" prop="zhoubianjingdian">
	      <el-input v-model="ruleForm.zhoubianjingdian"
                placeholder="周边景点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="客房类型" prop="kefangleixing">
              <el-input v-model="ruleForm.kefangleixing" 
                placeholder="客房类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="客房面积" prop="kefangmianji">
          <el-input v-model="ruleForm.kefangmianji" 
              placeholder="客房面积" clearable  :readonly="ro.kefangmianji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="客房面积" prop="kefangmianji">
              <el-input v-model="ruleForm.kefangmianji" 
                placeholder="客房面积" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="免费宽带" prop="mianfeikuandai">
          <el-select v-model="ruleForm.mianfeikuandai" placeholder="请选择免费宽带">
            <el-option
                v-for="(item,index) in mianfeikuandaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="免费宽带" prop="mianfeikuandai">
	      <el-input v-model="ruleForm.mianfeikuandai"
                placeholder="免费宽带" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.jiudianzhaopian" label="酒店照片" prop="jiudianzhaopian">
          <file-upload
          tip="点击上传酒店照片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.jiudianzhaopian?ruleForm.jiudianzhaopian:''"
          @change="jiudianzhaopianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.jiudianzhaopian" label="酒店照片" prop="jiudianzhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jiudianzhaopian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                                                                                                              <el-col :span="12">
...
export default {
  data() {
	...
	kefangleixing : false,
	kefangmianji : false,
	mianfeikuandai : false,
	jiudianzhaopian : false,
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiudianweizhi = true;
            continue;
                    ...
                    if(o=='zhoubianjingdian'){
            this.ruleForm.zhoubianjingdian = obj[o];
	    this.ro.zhoubianjingdian = true;
            continue;
          }
                    if(o=='kefangleixing'){
	    ...
	    this.ro.kefangleixing = true;
            continue;
                    ...
                    if(o=='kefangmianji'){
            this.ruleForm.kefangmianji = obj[o];
	    this.ro.kefangmianji = true;
            continue;
          }
                    if(o=='mianfeikuandai'){
            this.ruleForm.mianfeikuandai = obj[o];
	    this.ro.mianfeikuandai = true;
            continue;
          }
                    if(o=='jiudianzhaopian'){
            this.ruleForm.jiudianzhaopian = obj[o];
	    this.ro.jiudianzhaopian = true;
            continue;
          }
                    if(o=='jiudianjieshao'){
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                                            ...
                                                                                                            jiudianzhaopianUploadChange(fileUrls) {
                this.ruleForm.jiudianzhaopian = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                            	addEditStyleChange() {
	  this.$nextTick(()=>{
