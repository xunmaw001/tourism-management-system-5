  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="特产名称" prop="techanmingcheng">
              <el-input v-model="ruleForm.techanmingcheng" 
                placeholder="特产名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="特产类型" prop="techanleixing">
        ...
        <div v-else>
          <el-form-item class="input" label="特产类型" prop="techanleixing">
	      <el-input v-model="ruleForm.techanleixing"
                placeholder="特产类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="特产规格" prop="techanguige">
          <el-input v-model="ruleForm.techanguige" 
              placeholder="特产规格" clearable  :readonly="ro.techanguige"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="特产规格" prop="techanguige">
              <el-input v-model="ruleForm.techanguige" 
                placeholder="特产规格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.techanzhaopian" label="特产照片" prop="techanzhaopian">
          <file-upload
          tip="点击上传特产照片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.techanzhaopian?ruleForm.techanzhaopian:''"
          @change="techanzhaopianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.techanzhaopian" label="特产照片" prop="techanzhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.techanzhaopian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                            <el-col :span="12">
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.techanleixing = true;
            continue;
                    ...
                    if(o=='techanguige'){
            this.ruleForm.techanguige = obj[o];
	    this.ro.techanguige = true;
            continue;
          }
                    if(o=='techanzhaopian'){
            this.ruleForm.techanzhaopian = obj[o];
	    this.ro.techanzhaopian = true;
            continue;
          }
                    if(o=='techanjieshao'){
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                            ...
                                                            techanzhaopianUploadChange(fileUrls) {
                this.ruleForm.techanzhaopian = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                        	addEditStyleChange() {
	  this.$nextTick(()=>{
