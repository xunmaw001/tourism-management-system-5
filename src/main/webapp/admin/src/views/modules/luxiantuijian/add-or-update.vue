<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="攻略标题" prop="gonglvebiaoti">
          <el-input v-model="ruleForm.gonglvebiaoti" 
              placeholder="攻略标题" clearable  :readonly="ro.gonglvebiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="攻略标题" prop="gonglvebiaoti">
              <el-input v-model="ruleForm.gonglvebiaoti" 
                placeholder="攻略标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="景点名称" prop="jingdianmingcheng">
          <el-select  @change="jingdianmingchengChange" v-model="ruleForm.jingdianmingcheng" placeholder="请选择景点名称">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.jingdianmingcheng" label="景点名称" prop="jingdianmingcheng">
          ...
          <el-form-item class="input" label="景点类型" prop="jingdianleixing">
              <el-input v-model="ruleForm.jingdianleixing" 
                placeholder="景点类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="景点等级" prop="jingdiandengji">
          <el-input v-model="ruleForm.jingdiandengji" 
              placeholder="景点等级" clearable  :readonly="ro.jingdiandengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="景点等级" prop="jingdiandengji">
              <el-input v-model="ruleForm.jingdiandengji" 
                placeholder="景点等级" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出游季节" prop="chuyoujijie">
          <el-input v-model="ruleForm.chuyoujijie" 
              placeholder="出游季节" clearable  :readonly="ro.chuyoujijie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出游季节" prop="chuyoujijie">
              <el-input v-model="ruleForm.chuyoujijie" 
                placeholder="出游季节" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="出发城市" prop="chufachengshi">
              <el-input v-model="ruleForm.chufachengshi" 
                placeholder="出发城市" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="出现方式" prop="chuxianfangshi">
          <el-select v-model="ruleForm.chuxianfangshi" placeholder="请选择出现方式">
            <el-option
                v-for="(item,index) in chuxianfangshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="出现方式" prop="chuxianfangshi">
	      <el-input v-model="ruleForm.chuxianfangshi"
                placeholder="出现方式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="行程天数" prop="xingchengtianshu">
              <el-input v-model="ruleForm.xingchengtianshu" 
                placeholder="行程天数" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.gonglvefengmian" label="攻略封面" prop="gonglvefengmian">
          <file-upload
          tip="点击上传攻略封面"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.gonglvefengmian?ruleForm.gonglvefengmian:''"
          @change="gonglvefengmianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.gonglvefengmian" label="攻略封面" prop="gonglvefengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.gonglvefengmian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                            <el-col :span="12">
          ...
          <el-form-item class="input" label="价格" prop="price">
              <el-input v-model="ruleForm.price" 
                placeholder="价格" readonly></el-input>
                                                                                                                                                      ...
                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="行程路线" prop="xingchengluxian">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xingchengluxian" label="行程路线" prop="xingchengluxian">
                    <span>{{ruleForm.xingchengluxian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                                                                                                                                                                                                                          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="详情内容" prop="xiangqingneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xiangqingneirong" label="详情内容" prop="xiangqingneirong">
                    <span v-html="ruleForm.xiangqingneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	chuyoujijie : false,
	chufachengshi : false,
	chuxianfangshi : false,
	xingchengtianshu : false,
	gonglvefengmian : false,
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jingdiandengji = true;
            continue;
                    ...
                    if(o=='chuyoujijie'){
            this.ruleForm.chuyoujijie = obj[o];
	    this.ro.chuyoujijie = true;
            continue;
          }
                    if(o=='chufachengshi'){
	    ...
	    this.ro.chufachengshi = true;
            continue;
                    ...
                    if(o=='chuxianfangshi'){
            this.ruleForm.chuxianfangshi = obj[o];
	    this.ro.chuxianfangshi = true;
            continue;
          }
	    ...
	    this.ro.xingchengtianshu = true;
            continue;
                    ...
                    if(o=='gonglvefengmian'){
            this.ruleForm.gonglvefengmian = obj[o];
	    this.ro.gonglvefengmian = true;
            continue;
          }
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                                                                ...
                                                                                                                this.chuxianfangshiOptions = "客车,大巴,高铁,动车,火车,飞机,轮渡".split(',')
                                                                                                                                                          },
                    // 下二随
    jingdianmingchengChange () {
      this.$http({
        url: `follow/jingdianjieshao/jingdianmingcheng?columnValue=`+ this.ruleForm.jingdianmingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                ...
                this.ruleForm.jingdianleixing = data.data.jingdianleixing
                                                ...
                                                if(data.data.jingdiandengji){
                this.ruleForm.jingdiandengji = data.data.jingdiandengji
              }
                                                if(data.data.chuyoujijie){
                this.ruleForm.chuyoujijie = data.data.chuyoujijie
              }
                                                                                                                                                                                                                                    } else {
          this.$message.error(data.msg);
        }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `luxiantuijian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.luxiantuijianCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                                                        ...
                                                                                                                        gonglvefengmianUploadChange(fileUrls) {
                this.ruleForm.gonglvefengmian = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                        	addEditStyleChange() {
	  this.$nextTick(()=>{
